...
<header id="header" id="home2">
    ...
    <div class="container main-menu">
        <div class="row align-items-center justify-content-between d-flex">
            <div id="logo">
                <a href="" style="color: white; font-size: 20px;"><i>FROM WAY</i><br><i>DOWNTOWN</i></a>
            </div>
        ...
        <div class="row fullscreen d-flex justify-content-center align-items-center">
            <div class="banner-content col-lg-9 col-md-12 justify-content-center ">
                ...
                <p class="text-white mx-auto">
                    네이버 뉴스에 자주 실리는 키워드를 한눈에 찾아볼 수 있습니다.
                </p>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <h6>About Us</h6>
                    <p>
                        If you own an Iphone, you’ve probably already worked out how much fun it is to use it to watch
                        movies-it has that.
                    </p>
                    <p class="footer-text">
                        ...
                        All rights reserved | This template is made with <i class="fa fa-heart-o"
                            ...
                            href="https://colorlib.com" target="_blank">Colorlib</a> and distributed by <a
                    ...
                    <div class="" id="mc_embed_signup">
                        <form target="_blank" novalidate="true"
                            ...
                            <input class="form-control" name="EMAIL" placeholder="Email Address"
                                   ...
                                   required="" type="email">
                            <button class="click-btn btn btn-default"><i class="lnr lnr-arrow-right"
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/popper./theme/js/1.12.9/umd/popper.min.js"
